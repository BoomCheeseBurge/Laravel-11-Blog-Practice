...
<main class="pt-8 pb-16 antialiased bg-white dark:bg-gray-900 lg:pt-16 lg:pb-24">
            ...
            <form action="#">
                <div class="mx-auto max-w-screen-sm items-center mb-3 space-y-4 sm:flex sm:space-y-0">
                    <div class="w-full relative">
                        ...
                        <input class="w-full block p-3 pl-9 text-sm text-gray-900 bg-white rounded-lg border border-gray-300 dark:placeholder-gray-400 dark:text-white dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 focus:ring-primary-500 focus:border-primary-500 sm:rounded-none sm:rounded-l-lg" placeholder="Enter your email" type="email" id="email" required="">
                    </div>
                    <div>
                        <button type="submit" class="bg-primary-700 border-primary-600 w-full px-5 py-3 text-sm font-medium text-center text-white rounded-lg border cursor-pointer dark:bg-primary-600 dark:focus:ring-primary-800 dark:hover:bg-primary-700 focus:ring-primary-300 focus:ring-4 hover:bg-primary-800 sm:rounded-none sm:rounded-r-lg">Subscribe</button>
                    </div>
                </div>
                <div class="newsletter-form-footer mx-auto max-w-screen-sm text-sm text-left text-gray-500 dark:text-gray-300">We care about the protection of your data. <a href="#" class="text-primary-600 font-medium dark:text-primary-500 hover:underline">Read our Privacy Policy</a>.</div>
            </form>
        </div>
    </div>
  </section>
  ...
  <footer class="antialiased bg-gray-50 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl p-4 py-6 lg:p-10 md:p-8">
        ...
        <hr class="my-6 border-gray-200 dark:border-gray-700 lg:my-8 sm:mx-auto">
