    ...
    <div class="min-h-full">
        <nav class="bg-gray-800" x-data="{ isOpen: false }">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="flex items-baseline ml-10 space-x-4">
                                ...
                                <a href="/about" class="px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:text-white hover:bg-gray-700">About</a>
                                <a href="/blog" class="px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:text-white hover:bg-gray-700">Blog</a>
                                <a href="/contact" class="px-3 py-2 text-sm font-medium text-gray-300 rounded-md hover:text-white hover:bg-gray-700">Contact</a>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
            ...
            <div x-show="isOpen" class="md:hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <a href="/about" class="block px-3 py-2 text-base font-medium text-gray-300 rounded-md hover:text-white hover:bg-gray-700">About</a>
                    <a href="/blog" class="block px-3 py-2 text-base font-medium text-gray-300 rounded-md hover:text-white hover:bg-gray-700">Blog</a>
                    <a href="/contact" class="block px-3 py-2 text-base font-medium text-gray-300 rounded-md hover:text-white hover:bg-gray-700">Contact</a>
                </div>
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 lg:px-8 sm:px-6">
                ...
                <article>
                    <h3>Title 1</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis totam est laudantium laborum eligendi iure numquam sed ullam voluptas iusto neque quisquam modi architecto exercitationem, similique officiis quam, inventore perspiciatis odio! Optio reiciendis dolorum aliquid. Reprehenderit tenetur quisquam similique voluptatem. Iure nesciunt nulla nostrum voluptate doloremque explicabo cupiditate earum vel natus fugiat, eos facilis pariatur obcaecati incidunt debitis officiis est dolorem cum. Vero, itaque. Tempora culpa sapiente dolor reiciendis debitis possimus eligendi! Incidunt, laborum voluptas ab officia doloremque reprehenderit et quam, aliquam expedita ad laboriosam. Accusamus odio quam soluta sint, eum est iste nesciunt vel ad iusto! Dolore, veritatis expedita.</p>
                </article>

                <article>
                    <h3>Title 2</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum, ad. Aut illo placeat unde ab est doloremque laborum neque nesciunt laboriosam amet, consectetur rem mollitia modi eveniet. Illum consectetur eaque autem quidem quas illo tempore sed totam odit repudiandae accusamus, impedit rem voluptates ipsum vitae dolorem quis eius molestiae ut, dignissimos sapiente ab facilis eligendi? Dolorum voluptatibus, aut cumque quod sapiente quos iste deleniti sequi tempora quis nulla tempore cum quia. Cumque nobis cupiditate, vero nihil quibusdam dolorum praesentium quas error qui laudantium recusandae temporibus dicta in dolores culpa earum inventore eligendi optio voluptatem perspiciatis ipsam! Maxime non cum ad!</p>
                </article>
            </div>
        </main>
    </div>
